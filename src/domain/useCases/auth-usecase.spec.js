...
const makeSut = () => {
  ...
  return {
    sut, loadUserByEmailRepositorySpy, encrypterSpy, tokenGeneratorSpy, updateAccessTokenRepositorySpy
  }
}
...
describe('Auth UseCase', () => {
  ...
  test('Should call LoadUserByEmailRepository with correct email', async () => {
    ...
    expect(loadUserByEmailRepositorySpy.email).toBe('valid_email@email.com')
  })
  ...
  test('Should throw if invalid dependencies are provided', async () => {
    ...
    for (const sut of suts) {
      const promise = sut.auth('any_email@email.com', 'valid_password')
